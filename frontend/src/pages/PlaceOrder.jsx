...
const PlaceOrder = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col sm:flex-row justify-between gap-4 py-5 sm:pt-14 min-h-[80vh] border-t"
    >
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
        <div className="my-5 text-xl sm:text-2xl ">
      ...
      {/* Placeholder for the right side content, such as order summary or payment options */}
      <div className="mt-8">
